    ...
    <table width="441" border="0">
      <tr>
        <td width="381" align="left" valign="top"><h2 style="font-size:30px"><?php $j=0; foreach ($Datos as $row){
							...
							$j++;}?></h2></td>
        <td width="50" align="right" valign="middle"><input name="Vendedor" type="hidden" value="<?php echo $Vendedor; ?>" /><input name="Buttom" type="image" id="Buttom" title="Atras" src="<?php echo base_url();?>files/images/FlechaI.png"/></td>
      </tr>
      <tr>
