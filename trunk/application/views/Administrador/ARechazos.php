...
<div id="center">
  <div id="cc">
    <form id="form1" method="post" action="<?php echo base_url();?>index.php/Control_Negociacion/rechazo_2/<?php echo $Id_Negociacion; ?>">
      <table width="441" border="0">
        ...
        <tr>
          <td><fieldset>
              <legend style="font-size:15px"><b>Motivo de rechazo</b></legend>
              <table width="410" border="0">

                <tr>
                  <td width="80" align="right"><font style="font-size:12px">Resumen:</font></td>
                  <td width="320">
                      <textarea name="ResumenC" id="ResumenC" style="width:280px; font-size-adjust:inherit; height:80px; font-size:15px;" onfocus="CambiaColor(this,'#FFCC00','#000000')" onblur="CambiaColor(this,'','#000000')" required="required"></textarea>
...
f12.add( Validate.Length, { maximum: 300 } );</script>
        ...
        <tr>
          <td align="right" valign="top">
              <input name="Submit" type="image" src="<?php echo base_url();?>files/images/send_icon.png" value="Enviar rechazo" OnClick="return confirm('Usted desea cambiar de estatus a esta negociaci&oacute;n?');"/>              </td>
          </tr>
      </table>
    </form>
    <p>&nbsp;</p>
