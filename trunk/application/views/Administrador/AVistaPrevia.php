...
var n2 = (n1/100) * (<?php echo $Neto; ?>);
var n3 = <?php echo $Neto; ?>;
...
<div id="center">
  <div id="cc">
    <form id="form1" method="post" action="<?php echo base_url();?>index.php/Control_Negociacion/rechazo/<?php echo $Id_Negociacion; ?>">
      <table width="441" border="0">
        <tr>
          <td width="400" valign="middle"><h2 style="font-size:30px">Codigo Negociaci&oacute;n (<?php echo $Id_Negociacion; ?>)</h2></td>
          <td width="31" align="right" valign="middle"><input type="image" src="<?php echo base_url();?>files/images/cancel.png" name="Submit" style="width:25px;" value="RECHAZAR" title="Rechazar Negociaci&oacute;n" /></td>
          </tr>
        <tr>
      ...
      <table width="441" border="0">
        <tr>
          <td><fieldset><legend style="font-size:15px"><b>Vista previa</b></legend>
              <a href="<?php echo base_url();?>index.php/Control_Negociacion/historial_status_a2/<?php echo $Id_Negociacion; ?>"><img src="<?php echo base_url();?>files/images/Status.png" alt="e" width="16" height="16" title="Historial negociacion"/></a><a href="<?php echo base_url();?>index.php/Control_Negociacion/cambio_status_a/<?php echo $Id_Negociacion; ?>"></a><a href="<?php echo base_url();?>index.php/Control_Negociacion/historial_status_d/<?php echo $Id_Negociacion; ?>/<?php echo $idcliente; ?>"></a>
<table width="410" border="0">
                  ...
                  <tr>
                    <td colspan="2"><strong>Cliente: </strong><?php foreach ($DatosCliente as $row){
							echo $row['Nombre']; echo '&nbsp'; echo $row['Apellido'];
							     }?></td>
                  </tr>
                  <tr>
                    <td colspan="2"><strong>Direcci&oacute;n: </strong><?php foreach ($DatosCliente as $row){
							echo $row['Direccion'];
							     }?></td>
                  </tr>
                  <tr>
                    <td><strong>R.I.F: </strong><?php foreach ($DatosCliente as $row){
							echo $row['Rif'];
							     }?></td>
                    <td><strong>EJECUTIVO DE VENTAS: </strong></td>
                  </tr>
                  <tr>
                    <td><strong>Telefonos: </strong><?php foreach ($DatosCliente as $row){
                  ...
                  <tr>
                    <td><strong>Fax: </strong><?php foreach ($DatosCliente as $row){
							echo $row['Telefono3']; 
							     }?></td>
                    <td><strong>Fecha: </strong><?php foreach ($DatosVendedor as $row){
							echo $row['FechaP']; 
							     }?></td>
                  </tr>
                  <tr>
                    <td colspan="2"><strong>Email: </strong><?php foreach ($DatosCliente as $row){
							echo $row['Email']; 
							     }?></td>
                  </tr>
                  <tr>
  ...
  <tr>
    <td>&nbsp;</td>
    <td width="60">&nbsp;</td>
    <td width="167" align="right"><b>Neto:</b></td>
    <td width="55"><?php echo $Neto; ?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td width="60">&nbsp;</td>
  ...
  <tr>
    ...
    <td><input name="resultado2" type="text" id="resultado2" style="border:none; width:50px; text-align:left" onkeyup="calcula('+')" value="<?php echo $Neto; ?>" maxlength="6" readonly="readonly" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2" align="right"><input type="reset" name="Submit2" value="CE"/>
                    <input type="button" name="Submit3" value="Calcular" onclick="sumar()"/></td>
    </tr>
  <tr>
    <td>&nbsp;</td>
    <td width="60">&nbsp;</td>
    <td colspan="2" align="right"><input type="hidden" name="Negociacion" id="Negociacion" style="width:20px" value="<?php echo $Id_Negociacion; ?>" />
                    <input type="image" src="<?php echo base_url();?>files/images/aprobar.png" title="Aprobar Negociaci&oacute;n" OnClick="return confirm('Usted desea aprobar esta negociaci&oacute;n?');"></td>
    </tr>
</table>
        ...
        <tr>
          <td valign="top"><form id="form3" method="post" action="<?php echo base_url();?>index.php/Control_Negociacion/atras_avista_previa" >
              <input name="Submit" type="image" src="<?php echo base_url();?>files/images/FlechaI.png" id="Submit" title="Atras" />
          </form>		  </td>
          </tr>
      </table>
    <p>&nbsp;</p>  </div>
