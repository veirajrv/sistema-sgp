  ...
  <div id="cc">
    <form id="form1" method="post" action="">
      <table width="441" border="0">
        <tr>
          <td width="141"><h2 style="font-size:30px">Productos</h2></td>
          <td width="256" valign="middle"><h2>( <font color="#0099FF">Marca</font> )</h2></td>
          <td width="30" align="right" valign="middle"><a href="<?php echo base_url();?>index.php/Control_Producto/nueva_marca"><img src="<?php echo base_url();?>files/images/agregar.png" alt="a" width="30" height="30" title="Agregar nueva marca" /></a></td>
        </tr>
        <tr>
