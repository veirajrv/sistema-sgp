...
<div id="center">
  <div id="cc">
    ...
    <table width="441" border="0">
      <tr>
        <td width="431">- <a style="color:#0099FF" onclick="javascript:window.open('<?php echo base_url();?>index.php/Control_Reporte/lista_negociacion')"><b>Lista de negociaciones</b></a></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>
