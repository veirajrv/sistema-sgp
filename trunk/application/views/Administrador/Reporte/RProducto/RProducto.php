  ...
  <div id="cc">
    <table width="440" border="0">
      <tr>
        ...
        <td width="235"><h2>( <font color="#0099FF">Productos</font> )</h2></td>
    ...
    <table width="441" border="0">
      <tr>
        <td width="431">- <a style="color:#0099FF" onclick="javascript:window.open('<?php echo base_url();?>index.php/Control_Reporte/lista_marca')"><b>Lista de marcas</b></a></td>
      </tr>
      <tr>
        <td>- <a style="color:#0099FF" onclick="javascript:window.open('<?php echo base_url();?>index.php/Control_Reporte/lista_linea')"><b>Lista de lineas</b></a></td>
      </tr>
      <tr>
        <td>- <a style="color:#0099FF" onclick="javascript:window.open('<?php echo base_url();?>index.php/Control_Reporte/lista_equipo')"><b>Lista de equipos</b></a></td>
      </tr>
      <tr>
        <td>- <a style="color:#0099FF" onclick="javascript:window.open('<?php echo base_url();?>index.php/Control_Reporte/lista_accesorio')"><b>Lista de accesorios</b></a></td>
      </tr>
    </table>
    <p>&nbsp;</p>
  </div><!-- END cc -->
