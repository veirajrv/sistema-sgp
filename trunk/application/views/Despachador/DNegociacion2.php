        ...
        <tr>
          <td><fieldset><legend style="font-size:15px"><b>Datos Institucion</b></legend>
              <table width="410" border="0">
                <tr>
                  <td width="120" align="right"><font style="font-size:12px">Institucion:</font></td>
                  <td width="280">
                    <select name="select2" id="select2" style="width:200px; font-size-adjust:inherit; height:30px; font-size:15px;" onfocus="CambiaColor(this,'#FFCC00','#000000')" onblur="CambiaColor(this,'','#000000')" required="required">
                       <option></option>
					   <?php
