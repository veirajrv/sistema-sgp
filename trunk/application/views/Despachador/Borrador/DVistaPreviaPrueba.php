...
<table width="851" border="0">
  <tr>
    <td width="474"><form id="form1" name="form1" method="post" action="<?php echo base_url();?>index.php/Control_Inicio/d_principal">
      <input type="submit" name="Submit" value="Salir" />
    
    </form>    </td>
    <td width="208"><form id="form3" method="post" action="<?php echo base_url();?>index.php/Control_Venta/atras_vista_previa">
      <div align="right">
