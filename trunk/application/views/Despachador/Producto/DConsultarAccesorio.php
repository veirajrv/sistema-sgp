...
<div id="center">
  <div id="cc">
    <form id="form1" method="post" action="<?php echo base_url();?>index.php/Control_Producto/dbuscar_accesorio">
      <table width="441" border="0">
        <tr>
          ...
          <td width="64" align="right" valign="middle"><a href="<?php echo base_url();?>index.php/Control_Producto/dnuevo_accesorio"><img src="<?php echo base_url();?>files/images/agregar.png" alt="a" width="30" height="30" title="Agregar nueva marca" /></a></td>
        </tr>
        <tr>
