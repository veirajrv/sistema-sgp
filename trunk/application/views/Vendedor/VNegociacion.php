...
<div id="center">
  <div id="cc">
    <form id="form1" method="post" action="<?php echo base_url();?>index.php/Control_Negociacion/agregar_negociacion">
        ...
        <tr>
          <td><fieldset><legend style="font-size:15px"><b>Datos Cliente</b></legend>
              <table width="410" border="0">
                <tr>
                  <td width="130" align="right"><font style="font-size:12px">Cliente:</font></td>
                  <td width="270">
