  ...
  <div id="cc">
    <form id="form1" method="post" action="<?php echo base_url();?>index.php/Control_Negociacion/actualizar_datos_c/<?php echo $Id; ?>">
      <table width="441" border="0">
        ...
        <tr>
          <td valign="top"><h4 style="color:#0066FF">PASO I </h4></td>
          <td colspan="2" align="center" valign="top"><?php if ($Contador <= 3){ } else {echo "<b><font title='Negociaci&oacute;n Expirada' style='font-size:20px' color='#FF0000'>ALERTA</font><br/>Negociacion Expirada</b>";}?></td>
          </tr>
        <tr>
    ...
    <form id="form2" method="post" action="<?php echo base_url();?>index.php/Control_Negociacion/agregar_equipo">
      <table width="441" border="0">
        <tr>
          <td width="427"><fieldset><legend style="font-size:15px"><b>Producto</b></legend>
            <table width="410" border="0">
              <tr>
              ...
              <tr>
                ...
                <td width="20" align="right"><a href="sdfsdf">
                  <?php $j=0; foreach ($Lista as $row){
							...
							echo '<a href="http://elp21.no-ip.info:4085/SGP/index.php/Control_Negociacion/eliminar_producto_2/'.$row['Id_HistorialNP2'].'/'.$Id.'/'.$Id_Negociacion.'">ELIMINAR</a>'; echo '</br>';
	  ...
	  <table width="440" border="0">
        <tr>
          <td width="434" align="right" valign="top">
              ...
              <input type="image" name="Submit" src="<?php echo base_url();?>files/images/50px-Flecha_derecha.png" title="Siguiente Paso" />              </td>
        </tr>
      </table>
    </form>
    </div>
