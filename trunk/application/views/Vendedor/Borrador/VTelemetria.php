...
<div id="center">
  <div id="cc">
    ...
    <form id="form3" method="post" action="<?php echo base_url();?>index.php/Control_Negociacion/telemetria_accesorios/<?php echo $Id_Negociacion?>/<?php echo $Status; ?>/<?php echo $idcliente; ?>">
