...
<table width="851" border="0">
  <tr>
    ...
    <td width="309"><form id="form3" method="post" action="<?php echo base_url();?>index.php/Control_Negociacion/atras_vista_previai">
      <div align="right">
  ...
  <tr>
    <td colspan="3">
      ...
      <table width="810" border="0">
          <tr>
            <td width="466" rowspan="2"><img src="<?php echo base_url();?>files/images/Logo_Formato.png" alt="a" width="147" height="69" /></td>
        ...
        <table width="811" border="0" cellspacing="0">
          ...
          <tr>
            ...
            <td width="151">&nbsp;</td>
            <td width="339">&nbsp;</td>
            <td width="173" align="right"><?php if($Total <> NULL){ echo "<b>SUB TOTAL:</b>"; 
							     }?></td>
