...
<div id="center">
  <div id="cc">
              ...
              <tr>
                ...
                <td width="20" align="right"><a href="sdfsdf">
                  <?php $j=0; foreach ($Lista as $row){
							...
							echo '<a href="elp21.no-ip.info:4085/SGP/index.php/Control_Negociacion/eliminar_producto_i2/'.$row['Id_HistorialNP2'].'/'.$Id.'/'.$Id_Negociacion.'">ELIMINAR</a>'; echo '</br>';
	...
	<form id="form3" method="post" action="<?php echo base_url();?>index.php/Control_Negociacion/paso_extra_i">
