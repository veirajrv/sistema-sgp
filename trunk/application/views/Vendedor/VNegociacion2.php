...
<div id="center">
  <div id="cc">
    <form id="form1" method="post" action="<?php echo base_url();?>index.php/Control_Negociacion/agregar_negociacion_2">
      <table width="441" border="0">
        <tr>
          <td><h2 style="font-size:30px">Nueva Negociacion</h2></td>
          </tr>
        <tr>
          <td><font style="font-size:12px"><a href="<?php echo base_url();?>index.php/Control_Negociacion">Cliente</a></font> | <font style="font-size:12px"><a href="<?php echo base_url();?>index.php/Control_Negociacion/index2">Institucion</a></font></td>
        </tr>
        <tr>
        ...
        <tr>
          <td><fieldset><legend style="font-size:15px"><b>Datos Institucion</b></legend>
              <table width="410" border="0">
                <tr>
                  <td width="130" align="right"><font style="font-size:12px">Institucion:</font></td>
                  <td width="270">
                    <select name="select2" id="combobox" style="width:200px; font-size-adjust:inherit; height:30px; font-size:15px;" onfocus="CambiaColor(this,'#FFCC00','#000000')" onblur="CambiaColor(this,'','#000000')" required="required">
                       <option></option>
					   <?php
