...
<div id="center">
  <div id="cc">
    <form id="form2" method="post" action="<?php echo base_url();?>index.php/Control_Negociacion/ir_negociacion/<?php echo $Id_Negociacion;?>">
      <table width="440" border="0">
        <tr>
          ...
          <td width="50" align="right" valign="middle"><input type="image" name="Submit" src="<?php echo base_url();?>files/images/FlechaI.png" title="Atras"/></td>
        </tr>
        <tr>
    ...
    <form id="form1" method="post" action="<?php echo base_url();?>index.php/Control_Negociacion/cambio_status_4/<?php echo $Id_Negociacion; ?>">
          ...
          <td><fieldset><legend style="font-size:15px"><b>Seguimiento</b></legend>
              <table width="410" border="0">
                ...
                <tr>
                  ...
                  <td><textarea name="ResumenC" id="ResumenC" style="width:240px; font-size-adjust:inherit; height:80px; font-size:15px;" onfocus="CambiaColor(this,'#FFCC00','#000000')" onblur="CambiaColor(this,'','#000000')" required="required"></textarea>
