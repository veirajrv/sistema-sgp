...
class Worksheet_BaseDrawing implements IComparable
{
	 ...
	 * Shadow
	 *
	 * @var Worksheet_Drawing_Shadow
	 */
	protected $_shadow;

    /**
     * Create a new Worksheet_BaseDrawing
     */
    ...
    public function setWorksheet(Worksheet $pValue = null, $pOverrideOld = false) {
    	if (is_null($this->_worksheet)) {
    		...
    		if ($pOverrideOld) {
    			...
    			throw new Exception("A Worksheet has already been assigned. Drawings can only exist on one Worksheet.");
    		}
    	}
    	return $this;
    }
     ...
     * Get Shadow
     *
     * @return Worksheet_Drawing_Shadow
     */
     ...
     * Set Shadow
     *
     * @param 	Worksheet_Drawing_Shadow $pValue
     * @throws 	Exception
     * @return Worksheet_BaseDrawing
     */
