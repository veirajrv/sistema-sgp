...
/**
 * CachedObjectStorage_CacheBase
 *
 * @category   PHPExcel
 * @package    CachedObjectStorage
 * @copyright  Copyright (c) 2006 - 2010 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class CachedObjectStorage_CacheBase {
	...
	public function __construct(Worksheet $parent) {
		...
		//	This is maintained within the cache controller to facilitate re-attaching it to Cell objects when
	...
	/**
	 *	Is a value set in the current CachedObjectStorage_ICache for an indexed cell?
	 *
