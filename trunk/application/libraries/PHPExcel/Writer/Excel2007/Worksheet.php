...
class Writer_Excel2007_Worksheet extends Writer_Excel2007_WriterPart
{
	...
	public function writeWorksheet($pSheet = null, $pStringTable = null)
	{
		if (!is_null($pSheet)) {
			...
			throw new Exception("Invalid Worksheet object passed.");
		}
	}
		...
		$objWriter->startElement('sheetViews');
			...
			$objWriter->writeAttribute('workbookViewId',	'0');
				...
				if ($pSheet->getFreezePane() != '') {
					...
					list($xSplit, $ySplit) = Cell::coordinateFromString($pSheet->getFreezePane());
			...
			if (is_object($pCell->getValue()) || $pCell->getValue() !== '') {
				...
				switch (strtolower($mappedType)) {
					case 'inlinestr':	// Inline string
						...
						} else if ($pCell->getValue() instanceof RichText) {
	 ...
	 * @throws	Exception
	 */
	private function _writeDrawings(Shared_XMLWriter $objWriter = null, Worksheet $pSheet = null)
	{
