 ...
 * @copyright  Copyright (c) 2006 - 2010 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Writer_HTML implements Writer_IWriter {
	/**
	 * PHPExcel object
	 *
	 * @var PHPExcel
	...
	private function _mapHAlign($hAlign) {
		switch ($hAlign) {
			...
			case Style_Alignment::HORIZONTAL_CENTER: return 'center';
	...
	private function _mapBorderStyle($borderStyle) {
		switch ($borderStyle) {
			case Style_Border::BORDER_NONE: return '0px';
			...
			case Style_Border::BORDER_THICK: return '2px solid';
	 ...
	 * @throws	Exception
	 */
	private function _writeImageTagInCell(Worksheet $pSheet, $coordinates) {
		// Construct HTML
		$html = '';
