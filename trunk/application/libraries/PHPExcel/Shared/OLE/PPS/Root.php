...
class Shared_OLE_PPS_Root extends Shared_OLE_PPS
	...
	*/
	...
	/**
	* Saving big data (PPS's with data bigger than Shared_OLE::OLE_DATA_SIZE_SMALL)
	*
	* @access public
	...
	*/
	...
	/**
	* get small data (PPS's with data smaller than Shared_OLE::OLE_DATA_SIZE_SMALL)
	*
	* @access public
	* @param array &$raList Reference to array of PPS's
	*/
	...
	*/
	public function _savePps(&$raList)
	{
		...
		if ($iCnt % $iBCnt) {
			for ($i = 0; $i < (($iBCnt - ($iCnt % $iBCnt)) * Shared_OLE::OLE_PPS_SIZE); ++$i) {
