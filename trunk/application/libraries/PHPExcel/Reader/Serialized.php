 ...
 * @copyright  Copyright (c) 2006 - 2010 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Reader_Serialized implements Reader_IReader
{
	/**
	...
	public function load($pFilename)
	{
		...
		if (!$this->fileSupportsUnserializePHPExcel($pFilename)) {
			throw new Exception("Invalid file format for Reader_Serialized: " . $pFilename . ".");
		}
    ...
    public function fileSupportsUnserializePHPExcel($pFilename = '') {
		...
		return Shared_File::file_exists("zip://$pFilename#phpexcel.xml");
    }
}
