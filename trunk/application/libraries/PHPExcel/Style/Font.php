 ...
 * @copyright  Copyright (c) 2006 - 2010 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Style_Font implements IComparable
{
	/* Underline types */
     ...
     * 			'bold'      => true,
     * 			'italic'    => false,
     * 			'underline' => Style_Font::UNDERLINE_DOUBLE,
     * 			'strike'    => false,
     * 			'color'     => array(
     * 				'rgb' => '808080'
     * 			)
     ...
     * Set Underline
     *
     * @param string $pValue	Style_Font underline type
     * @return Style_Font
     */
    public function setUnderline($pValue = Style_Font::UNDERLINE_NONE) {
    	if ($pValue == '') {
    		$pValue = Style_Font::UNDERLINE_NONE;
    	}
		if ($this->_isSupervisor) {
