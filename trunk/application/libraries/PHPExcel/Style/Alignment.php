 ...
 * @copyright  Copyright (c) 2006 - 2010 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Style_Alignment implements IComparable
{
    ...
    public function __construct($isSupervisor = false)
    {
    	...
    	// Initialise values
    	$this->_horizontal			= Style_Alignment::HORIZONTAL_GENERAL;
    	$this->_vertical			= Style_Alignment::VERTICAL_BOTTOM;
