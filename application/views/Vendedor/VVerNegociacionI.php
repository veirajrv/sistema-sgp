  ...
  <div id="cc">
      <table width="441" border="0">
        <tr>
          ...
          <td width="74" align="right" valign="middle"><a href="<?php echo base_url();?>index.php/Control_negociacion/index2"><img src="<?php echo base_url();?>files/images/agregar.png" alt="a" width="30" height="30" title="Agregar nuevo cliente" /></a></td>
        </tr>
        <tr>
