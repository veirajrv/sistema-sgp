  ...
  <div id="cc">
    <form id="form1" method="post" action="">
      <table width="441" border="0">
        ...
        <tr>
          <td><h4 style="color:#0066FF">PASO II</h4></td>
        </tr>
        <tr>
    ...
    <form id="form3" method="post" action="<?php echo base_url();?>index.php/Control_Negociacion/agregar_otro_accesorios4/<?php echo $Id_Negociacion; ?>/<?php echo $Status; ?>/<?php echo $idcliente; ?>">
      <table width="440" border="0">
        <tr>
          <td width="434"><fieldset><legend style="font-size:15px"><b>Accesorio</b></legend>
            ...
            <tr>
              ...
              <td width="20"><a href="sdfsdf">
                <?php $j=0; foreach ($Lista as $row){
							...
							echo '<a href="elp21.no-ip.info:4085/SGP/index.php/Control_Negociacion/eliminar_producto_i/'.$row['Id_HistorialNP'].'/'.$idcliente.'/'.$Id_Negociacion.'">ELIMINAR</a>'; echo '</br>';
	...
	<table width="437" border="0">
      <tr>
        ...
        <td width="114" align="right" valign="top"><form id="form2" method="post" action="<?php echo base_url();?>index.php/Control_Negociacion/fin_negociacion">
