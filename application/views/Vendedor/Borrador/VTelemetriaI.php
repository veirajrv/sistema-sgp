...
<div id="center">
  <div id="cc">
    ...
    <form id="form3" method="post" action="<?php echo base_url();?>index.php/Control_Negociacion/telemetria_accesorios_institucion/<?php echo $Id_Negociacion?>/<?php echo $Status; ?>/<?php echo $idcliente; ?>">
  ...
  <tr>
    <td align="right">&nbsp;</td>
    <td width="200" align="right"><input type="submit" name="Buscar" id="Buscar" value="Buscar Accesorios" OnClick="return confirm('Usted desea buscar los accesorios de este equipo?');"/></td>
    <td width="76">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="3">&nbsp;</td>
            ...
            <tr>
              ...
              <td><a href="sdfsdf">
                <?php $j=0; foreach ($Lista as $row){
							...
							echo '<a href="'.base_url().'index.php/Control_Negociacion/eliminar_producto2/'.$row['Id_HistorialNP'].'/'.$idcliente.'/'.$Id_Negociacion.'">ELIMINAR</a>'; echo '</br>';
