              ...
              <tr>
                ...
                <td width="20"><a href="sdfsdf">
                  <?php $j=0; foreach ($Lista as $row){
							...
							echo '<a href="http://elp21.no-ip.info:4085/SGP/index.php/Control_Negociacion/eliminar_producto/'.$row['Id_HistorialNP'].'/'.$idcliente.'/'.$Id_Negociacion.'">ELIMINAR</a>'; echo '</br>';
	...
	<table width="437" border="0">
      <tr>
        ...
        <td width="113" align="right" valign="top"><form id="form2" method="post" action="<?php echo base_url();?>index.php/Control_Negociacion/fin_negociacion">
          <input type="submit" name="Submit2" value="Finalizar" onclick="return confirm('Al finalizar esta negociación la misma sera enviada a la lista de negociaciones por aprobar');"/>
        </form></td>
      </tr>
    </table>
    <p>&nbsp;</p>
