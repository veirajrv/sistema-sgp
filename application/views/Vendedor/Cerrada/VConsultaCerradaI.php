...
<div id="center">
  <div id="cc">
    <form id="form1" method="post" action="<?php echo base_url();?>index.php/ControlNegociacion/ActualizarDatosI2/<?php echo $Usuario ?>/<?php echo $Id; ?>">
      <table width="441" border="0">
        <tr>
          <td width="365"><h2 style="font-size:30px">Codigo Negociaci&oacute;n (<?php echo $Id_Negociacion; ?>)</h2></td>
          <td align="right" valign="top"><a href="<?php echo base_url();?>index.php/Control_Negociacion/historial_status/<?php echo $Id_Negociacion; ?>/<?php echo $Id; ?>"><img src="<?php echo base_url();?>files/images/List.png" alt="e" width="25" height="25" title="Historial negociacion"/></a></td>
          </tr>
        <tr>
          <td colspan="2"><hr align="left" style="width:435px;" /></td>
        </tr>
        <tr>
          <td colspan="2" align="center"><font style="font-size:15px; height:8px"><?php if ($Status == 'Borrador') { echo "<b><font color='#FF9900'>$Status $Porcentaje %</font></b>";} if ($Status == 'Activa') { echo "<b><font color='#6600FF'>$Status $Porcentaje %</font></b>";} if ($Status == 'Ganada') { echo "<b><font color='#00CC00'>$Status $Porcentaje %</font></b>";} if ($Status == 'Perdida') { echo "<b><font color='#FF0000'>$Status $Porcentaje %</font></b>";} if ($Status == 'Cerrada') { echo "<b><font color='#0033FF'>$Status $Porcentaje %</font></b>";}?></font></td>
        </tr>
        <tr>
          <td colspan="2"><hr align="left" style="width:435px;" /></td>
        </tr>
        <tr>
          <td colspan="2"><fieldset><legend style="font-size:15px"><b>Datos Cliente</b></legend>
        ...
        <tr>
          <td colspan="2"><fieldset><legend style="font-size:15px"><b>Datos Negociacion</b></legend>
            <table width="410" border="0">
    ...
    <table width="441" border="0">
      <tr>
        <td width="435" align="right"><form id="form2" method="post" action="<?php echo base_url();?>index.php/Control_Negociacion/fin_negociacion">
