          ...
          <td colspan="2"><fieldset><legend style="font-size:15px">Lista de Instituciones</legend>
              <table width="410" border="0">
                <tr>
                  ...
                  <td width="284">
                    <form id="form1" method="post" action="<?php echo base_url();?>index.php/Control_Institucion/ver_perfil">
                ...
                <tr>
                  ...
                  <td width="284">
                    <form id="form2" method="post" action="<?php echo base_url();?>index.php/Control_Institucion/ver_perfil">
