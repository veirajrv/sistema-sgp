...
<div id="center">
  <div id="cc">
  <form id="form2" method="post" action="<?php echo base_url();?>index.php/Control_Inicio/v_principal">
  ...
  <form id="form1" method="post" action="<?php echo base_url();?>index.php/Control_Perfil/modificar_perfil">
...
f10.add( Validate.Length, { is: 11 } );</script>                  
        ...
        <tr>
          <td align="right"><input type="image" src="<?php echo base_url();?>files/images/Actualizando.png" name="Submit" title="Actualizar datos" onclick="return confirm('Usted desea actualizar sus datos personales?');"/></td>
          </tr>
      </table>
    </form>
</div>
