    ...
    <form id="form1" method="post" action="<?php echo base_url();?>index.php/Control_Negociacion/rechazo/<?php echo $Id_Negociacion; ?>">
      <table width="441" border="0">
        <tr>
          ...
          <td width="31" align="right" valign="middle"><input type="image" src="<?php echo base_url();?>files/images/cancel.png" name="Submit" style="width:25px;" value="RECHAZAR" title="Rechazar Negociaci&oacute;n" />
		  </td>
        </tr>
        <tr>
              ...
              <form name="MyForm" method="post" action="<?php echo base_url();?>index.php/Control_Negociacion/aprobar">
                <table width="410" border="0">
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td width="172" align="right"><b>Neto:</b></td>
                  ...
                  <tr>
                    ...
                    <td><input name="numero2" type="text" id="numero2" style="border:none; width:30px; text-align:left" onkeypress="return soloNumeros(event)" value="" maxlength="2"/>
                      %</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <input type="button" name="Submit2" value="Calcular" onclick="sumar()"/></td>
                  </tr>
                  <tr>
                    <td width="105">&nbsp;</td>
                    <td width="60">&nbsp;</td>
