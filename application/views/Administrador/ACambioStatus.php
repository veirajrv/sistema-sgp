...
<div id="center">
  <div id="cc">
  <form id="form3" method="post" action="<?php echo base_url();?>index.php/Control_Negociacion/ir_negociacion_atras/<?php echo $Id_Negociacion; ?>">
  ...
  <form id="form1" method="post" action="<?php echo base_url();?>index.php/Control_Negociacion/cambio_status_2a/<?php echo $Id_Negociacion; ?>">
      <table width="441" border="0">
        <tr>
...
f12.add( Validate.Length, { maximum: 300 } );</script>
        ...
        <tr>
          <td align="right" valign="top"><input name="Submit" type="image" src="<?php echo base_url();?>files/images/Actualizando.png" value="Actualizar Estatus" OnClick="return confirm('Usted desea cambiar de estatus a esta negociaci&oacute;n?');" title="Actualizar Estatus"/></td>
          </tr>
      </table>
    </form>
    <p>&nbsp;</p>
