      ...
      <table width="441" border="0">
        ...
        <tr>
          <td colspan="3"><table width="427" border="0">
            <tr>
              <td width="150" align="right"><input name="Buscar" type="text" id="Buscar" style="width:150px; font-size-adjust:inherit; height:30px; font-size:15px;" onfocus="CambiaColor(this,'#FFCC00','#000000')" onblur="CambiaColor(this,'','#000000')" placeholder="Buscar accesorio" required="required" onkeypress="return soloNumeros(event)"/></td>
              <td width="32"><input name="image" type="image" value="Buscar" src="<?php echo base_url();?>files/images/lupa-32x32.png"/></td>
              <td width="231"><?php if(isset($Mensaje))
		{
