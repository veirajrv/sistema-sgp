    ...
    <form id="form1" method="post" action="<?php echo base_url();?>index.php/Control_Producto/buscar_accesorio">
      <table width="441" border="0">
        <tr>
          ...
          <td width="186" valign="middle"><h2>( <font color="#0099FF">Accesorio</font> )</h2></td>
          <td width="64" align="right" valign="middle"><a href="<?php echo base_url();?>index.php/Control_Producto/nuevo_accesorio"><img src="<?php echo base_url();?>files/images/agregar.png" alt="a" width="30" height="30" title="Agregar nueva marca" /></a></td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="3"><table width="427" border="0">
            <tr>
              <td width="264"><select name="Vendedor" id="Vendedor" style="width:200px; font-size-adjust:inherit; height:30px; font-size:15px;" onfocus="CambiaColor(this,'#FFCC00','#000000')" onblur="CambiaColor(this,'','#000000')" required="required">
                <option></option>
                <?php
						foreach ($Equipos as $row) {
				  ?>
                <option value="<?php echo $row['Codigo']; ?>" <?php echo set_select('Hola',$row['Codigo']); ?> ><?php echo $row['Codigo']; echo " - "; echo $row['Equipo']; ?></option>
                <?php
					}
					?>
              </select>
                <input type="submit" name="Submit2" value="Buscar" /></td>
              <td width="153"><?php if(isset($Mensaje))
		{
