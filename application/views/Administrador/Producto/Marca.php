...
<div id="center">
  <div id="cc">
  <form id="form3" method="post" action="<?php echo base_url();?>index.php/Control_Producto">
    <table width="440" border="0">
      <tr>
        <td width="220"><h2 style="font-size:30px">Nueva Marca</h2></td>
  ...
  <table width="440" border="0">
        <tr>
          <td colspan="4" align="center"><?php if(isset($Mensaje))
		{
        ...
        <tr>
          ...
          <td colspan="3"><form id="form1" method="post" action="<?php echo base_url();?>index.php/Control_Producto/crear_marca">
            <input name="Marca" type="text" id="Marca" onkeypress="return validar(event)" style="width:200px; font-size-adjust:inherit; height:30px; font-size:15px;" maxlength="150" required="required" onfocus="CambiaColor(this,'#FFCC00','#000000')" onblur="CambiaColor(this,'','#000000')"/>
