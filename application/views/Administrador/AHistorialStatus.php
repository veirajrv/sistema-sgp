...
<div id="center">
  <div id="cc">
    <form id="form1" method="post" action="<?php echo base_url();?>index.php/Control_Negociacion/ir_negociacion_atras/<?php echo $Id_Negociacion; ?>">
      <table width="441" border="0">
        <tr>
          <td width="381" valign="top"><h2 style="font-size:30px">Codigo Negociaci&oacute;n (<?php echo $Id_Negociacion; ?>)</h2></td>
