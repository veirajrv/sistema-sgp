...
<div id="center">
  <div id="cc">
  <form id="form2" method="post" action="<?php echo base_url();?>index.php/Control_Cliente/buscar_vendedores">
    <table width="441" border="0">
      <tr>
        <td width="381"><h2 style="font-size:30px">Busqueda Cliente</h2></td>
