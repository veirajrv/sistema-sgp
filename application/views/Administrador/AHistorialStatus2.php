...
<div id="center">
  <div id="cc">
    <form id="form1" method="post" action="<?php echo base_url();?>index.php/Control_Negociacion/sin_aprobar_2">
      <table width="441" border="0">
        <tr>
          <td width="381" valign="top"><h2 style="font-size:30px">Codigo Negociaci&oacute;n (<?php echo $Id_Negociacion; ?>)<input type="hidden" name="SinAprobar" id="SinAprobar" value="<?php echo $Id_Negociacion; ?>" /></h2></td>
          <td width="50" align="right" valign="top">
            <input type="image" src="<?php echo base_url();?>files/images/FlechaI.png" name="Submit" value="Atras" />          </td>
        </tr>
        <tr>
    ...
    <form id="form2" method="post" action="<?php echo base_url();?>index.php/Control_Negociacion/atras_avista_previa">
