...
<div id="center">
  <div id="cc">
    <form id="form1" method="post" action="<?php echo base_url();?>index.php/Control_Venta/actualizar_datos_i/<?php echo $Id; ?>">
      <table width="441" border="0">
        <tr>
          <td width="366"><h2 style="font-size:30px">Codigo Negociaci&oacute;n (<?php echo $Id_Negociacion; ?>)</h2>                        </td>
          <td width="35" align="right" valign="top"><a href="<?php echo base_url();?>index.php/Control_Venta/historial_status_i/<?php echo $Id_Negociacion; ?>/<?php echo $Id; ?>"><img src="<?php echo base_url();?>files/images/List.png" alt="e" width="25" height="25" title="Historial negociacion"/></a></td>
          <td width="26" align="right" valign="top"><a href="<?php echo base_url();?>index.php/Control_Venta/cambio_status_i/<?php echo $Id_Negociacion; ?>/<?php echo $Id; ?>"><img src="<?php echo base_url();?>files/images/icono_filtro.png" alt="" width="25" height="25" title="Cambio de estatus" /></a></td>
        </tr>
        <tr>
          ...
          <td colspan="3"><fieldset><legend style="font-size:15px"><b>Datos Cliente</b></legend>
              <table width="410" border="0">
                <tr>
                  ...
                  <td width="120" rowspan="2"><div align="center"><a href="<?php echo base_url();?>index.php/Control_Venta/vista_previa_i/<?php echo $Id_Negociacion; ?>/<?php echo $Id; ?>"><img src="<?php echo base_url();?>files/images/698634678.png" alt="" width="42" height="42" title="Vista previa" /></a><br />
                    Vista Previa </div></td>
                </tr>
                <tr>
    ...
    <form id="form2" method="post" action="<?php echo base_url();?>index.php/Control_Venta/agregar_equipo_i">
      <table width="441" border="0">
        <tr>
              ...
              <tr>
                ...
                <td width="20" align="right"><a href="sdfsdf">
                  <?php $j=0; foreach ($Lista as $row){
							...
							echo '<a href="http://elp21.no-ip.info:4085/SGP/index.php/Control_Venta/eliminar_producto_i2/'.$row['Id_HistorialNP2'].'/'.$Id.'/'.$Id_Negociacion.'">ELIMINAR</a>'; echo '</br>';
