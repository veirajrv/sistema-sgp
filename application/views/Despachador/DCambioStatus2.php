...
<div id="center">
  <div id="cc">
  <form id="form2" method="post" action="<?php echo base_url();?>index.php/Control_Venta/ir_negociacion2/<?php echo $Id_Negociacion;?>">
  ...
  <form id="form1" method="post" action="<?php echo base_url();?>index.php/Control_Venta/cambio_status_22/<?php echo $Id_Negociacion; ?>">
