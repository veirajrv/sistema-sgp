...
class Writer_Excel2007_Workbook extends Writer_Excel2007_WriterPart
{
	 ...
	 * @throws 	Exception
	 */
	private function _writeBookViews(Shared_XMLWriter $objWriter = null, PHPExcel $pPHPExcel = null)
	{
		// bookViews
	 ...
	 * @throws 	Exception
	 */
	private function _writeWorkbookProtection(Shared_XMLWriter $objWriter = null, PHPExcel $pPHPExcel = null)
	{
	 ...
	 * @throws 	Exception
	 */
	private function _writeCalcPr(Shared_XMLWriter $objWriter = null)
	{
	 ...
	 * @throws 	Exception
	 */
	private function _writeSheets(Shared_XMLWriter $objWriter = null, PHPExcel $pPHPExcel = null)
	{
		// Write sheets
	 ...
	 * @throws 	Exception
	 */
	private function _writeDefinedNames(Shared_XMLWriter $objWriter = null, PHPExcel $pPHPExcel = null)
	{
		// Write defined names
	 ...
	 * @throws 	Exception
	 */
	private function _writeNamedRanges(Shared_XMLWriter $objWriter = null, PHPExcel $pPHPExcel)
	{
		// Loop named ranges
	...
	private function _writeDefinedNameForAutofilter(Shared_XMLWriter $objWriter = null, Worksheet $pSheet = null, $pSheetId = 0)
	{
		...
		if ($pSheet->getAutoFilter() != '') {
			...
			// Create absolute coordinate and write as raw text
			$range = Cell::splitRange($pSheet->getAutoFilter());
			$range = $range[0];
