...
class Writer_Excel2007_Style extends Writer_Excel2007_WriterPart
{
	 ...
	 * @param 	Style_Fill			$pFill			Fill style
	 * @throws 	Exception
	 */
	 ...
	 * @throws 	Exception
	 */
	private function _writeCellStyleXf(Shared_XMLWriter $objWriter = null, Style $pStyle = null, PHPExcel $pPHPExcel = null)
	{
		// xf
		$objWriter->startElement('xf');
			$objWriter->writeAttribute('xfId', 0);
	 ...
	 *
	 * @param 	PHPExcel				$pPHPExcel
	 * @return 	Style[]		All styles in PHPExcel
	 * @throws 	Exception
	 */
	 ...
	 *
	 * @param 	PHPExcel							$pPHPExcel
	 * @return 	Style_Conditional[]		All conditional styles in PHPExcel
	 * @throws 	Exception
	 */
	 ...
	 *
	 * @param 	PHPExcel						$pPHPExcel
	 * @return 	Style_Font[]		All fonts in PHPExcel
	 * @throws 	Exception
	 */
	 ...
	 *
	 * @param 	PHPExcel						$pPHPExcel
	 * @return 	Style_Borders[]		All borders in PHPExcel
	 * @throws 	Exception
	 */
	 ...
	 *
	 * @param 	PHPExcel								$pPHPExcel
	 * @return 	Style_NumberFormat[]		All number formats in PHPExcel
	 * @throws 	Exception
	 */
