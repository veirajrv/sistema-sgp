 ...
 * @copyright  Copyright (c) 2006 - 2010 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Writer_Excel5 implements Writer_IWriter
{
	/**
	 ...
	 * Formula parser
	 *
	 * @var Writer_Excel5_Parser
	 */
	private $_parser;


	/**
	 * Create a new Writer_Excel5
	 *
	...
	public function __construct(PHPExcel $phpExcel) {
		...
		$this->_parser          = new Writer_Excel5_Parser($this->_BIFF_version);
	...
	public function save($pFilename = null) {
		...
		$this->_writerWorkbook = new Writer_Excel5_Workbook($this->_phpExcel, $this->_BIFF_version,
		...
		for ($i = 0; $i < $countSheets; ++$i) {
			$this->_writerWorksheets[$i] = new Writer_Excel5_Worksheet($this->_BIFF_version,
