...
class IOFactory
{
	 ...
	 *	@param	string $classname 	Example: Writer_{0}
	 */
	...
	/**
	 *	Create Writer_IWriter
	 *
	 *	@static
	 *	@access	public
	 *	@param	PHPExcel $phpExcel
	 *	@param	string  $writerType	Example: Excel2007
	 *	@return	Writer_IWriter
	 *	@throws	Exception
	 */
	...
	/**
	 *	Create Reader_IReader
	 *
	 *	@static
	 *	@access	public
	 *	@param	string $readerType	Example: Excel2007
	 *	@return	Reader_IReader
	 *	@throws	Exception
	 */
	...
	/**
	 *	Loads PHPExcel from file using automatic Reader_IReader resolution
	 *
	 *	@static
	 *	@access public
	...
	/**
	 *	Identify file type using automatic Reader_IReader resolution
	 *
	 *	@static
	 *	@access public
	 *	@param 	string 		$pFileName
	...
	/**
	 *	Create Reader_IReader for file using automatic Reader_IReader resolution
	 *
	 *	@static
	 *	@access	public
	 *	@param 	string 		$pFileName
