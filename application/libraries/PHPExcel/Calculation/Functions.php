...
/** Matrix */
require_once ROOT . 'PHPExcel/Shared/JAMA/Matrix.php';
...
class Calculation_Functions {
	 ...
	 *													Calculation_Functions::COMPATIBILITY_EXCEL			'Excel'
	 *													Calculation_Functions::COMPATIBILITY_GNUMERIC		'Gnumeric'
	 *													Calculation_Functions::COMPATIBILITY_OPENOFFICE	'OpenOfficeCalc'
	 ...
	 *												Permitted values are:
	 *													Calculation_Functions::RETURNDATE_PHP_NUMERIC		'P'
	 *													Calculation_Functions::RETURNDATE_PHP_OBJECT		'O'
	 *													Calculation_Functions::RETURNDATE_EXCEL			'E'
	 *	@return	 boolean							Success or failure
	 */
...
//			$CumPGuessMinus1 = $CumPGuess - $PGuess;
	...
	public static function DATE($year = 0, $month = 1, $day = 1) {
		...
		switch (self::getReturnDateType()) {
			case self::RETURNDATE_EXCEL			: return (float) $excelDateValue;
												  break;
			case self::RETURNDATE_PHP_NUMERIC	: return (integer) Shared_Date::ExcelToPHP($excelDateValue);
												  break;
			case self::RETURNDATE_PHP_OBJECT	: return Shared_Date::ExcelToPHPObject($excelDateValue);
												  break;
		}
	}	//	function DATE()
	...
	public static function TIME($hour = 0, $minute = 0, $second = 0) {
		...
		switch (self::getReturnDateType()) {
			case self::RETURNDATE_EXCEL			: $date = 0;
												  ...
												  break;
			case self::RETURNDATE_PHP_NUMERIC	: return (integer) Shared_Date::ExcelToPHP(Shared_Date::FormattedPHPToExcel(1970, 1, 1, $hour-1, $minute, $second));	// -2147468400; //	-2147472000 + 3600
												  break;
	...
	private static function _getDateValue($dateValue) {
		if (!is_numeric($dateValue)) {
			...
			if ((is_object($dateValue)) && ($dateValue instanceof Shared_Date::$dateTimeObjectType)) {
	...
	public static function TIMEVALUE($timeValue) {
		...
		if (($PHPDateArray !== False) && ($PHPDateArray['error_count'] == 0)) {
			...
			switch (self::getReturnDateType()) {
				case self::RETURNDATE_EXCEL			: return (float) $excelDateValue;
													  break;
				case self::RETURNDATE_PHP_NUMERIC	: return (integer) $phpDateValue = Shared_Date::ExcelToPHP($excelDateValue+25569) - 3600;;
													  break;
	...
	public static function DATETIMENOW() {
		...
		$retValue = False;
		switch (self::getReturnDateType()) {
			case self::RETURNDATE_EXCEL			: $retValue = (float) Shared_Date::PHPToExcel(time());
												  break;
	...
	public static function DATENOW() {
		...
		switch (self::getReturnDateType()) {
			case self::RETURNDATE_EXCEL			: $retValue = (float) $excelDateTime;
												  break;
			case self::RETURNDATE_PHP_NUMERIC	: $retValue = (integer) Shared_Date::ExcelToPHP($excelDateTime) - 3600;
												  break;
			case self::RETURNDATE_PHP_OBJECT	: $retValue = Shared_Date::ExcelToPHPObject($excelDateTime);
												  break;
		}
		date_default_timezone_set($saveTimeZone);
	...
	public static function WORKDAY($startDate,$endDays) {
		...
		switch (self::getReturnDateType()) {
			case self::RETURNDATE_EXCEL			: return (float) $endDate;
												  break;
			case self::RETURNDATE_PHP_NUMERIC	: return (integer) Shared_Date::ExcelToPHP($endDate);
												  break;
			case self::RETURNDATE_PHP_OBJECT	: return Shared_Date::ExcelToPHPObject($endDate);
												  break;
		}
	}	//	function WORKDAY()
	...
	public static function EDATE($dateValue = 1, $adjustmentMonths = 0) {
		...
		switch (self::getReturnDateType()) {
			case self::RETURNDATE_EXCEL			: return (float) Shared_Date::PHPToExcel($PHPDateObject);
												  break;
			case self::RETURNDATE_PHP_NUMERIC	: return (integer) Shared_Date::ExcelToPHP(Shared_Date::PHPToExcel($PHPDateObject));
												  break;
