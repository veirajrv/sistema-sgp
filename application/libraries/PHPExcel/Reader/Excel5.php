 ...
 * @copyright  Copyright (c) 2006 - 2010 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Reader_Excel5 implements Reader_IReader
{
	// ParseXL definitions
	...
	/**
	 * Reader_IReadFilter instance
	 *
	 * @var Reader_IReadFilter
	 */
	 ...
	 * Set read filter
	 *
	 * @param Reader_IReadFilter $pValue
	 * @return Reader_Excel5
	 */
	...
	/**
	 * Create a new Reader_Excel5 instance
	 */
	...
	/**
	 * Can the current Reader_IReader read the file?
	 *
		...
		for ($i = 0; $i < $countProperties; ++$i) {
			...
			switch ($type) {
				...
				case 0x40: // Filetime (64-bit value representing the number of 100-nanosecond intervals since January 1, 1601)
					// PHP-time
					$value = Shared_OLE::OLE2LocalDate(substr($this->_summaryInformation, 52 + $offset, 8));
					break;
	...
	private function _readBIFF8CellAddress($cellAddressStructure)
	{
		...
		// offset: 2; size: 2; index to column or column offset + relative flags
			...
			$column = Cell::stringFromColumnIndex(0x00FF & $this->_GetInt2d($cellAddressStructure, 2));
	...
	private function _readBIFF8CellRangeAddress($subData)
	{
		...
		// offset: 4; size: 2; index to first column or column offset + relative flags
			...
			// bit: 7-0; mask 0x00FF; column index
			$fc = Cell::stringFromColumnIndex(0x00FF & $this->_GetInt2d($subData, 4));
		...
		// offset: 6; size: 2; index to last column or column offset + relative flags
			...
			// bit: 7-0; mask 0x00FF; column index
			$lc = Cell::stringFromColumnIndex(0x00FF & $this->_GetInt2d($subData, 6));
	...
	private function _encodeUTF16($string, $compressed = '')
	{
		...
		$result = Shared_String::ConvertEncoding($string, 'UTF-8', 'UTF-16LE');
